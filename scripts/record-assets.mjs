...
for (const path of ['components/expedition/institute-mark.tsx','components/ocean/field-station-beacon.tsx','components/ocean/beacon-body.tsx','lib/ocean-surface.ts','lib/ocean-lighting.ts']) assets.push({path, kind:'procedural', sourceKind:'project-source', creator:'Ocean Drive project contributors', source:path, retrieved:'2026-09-15', rights:'Project-authored source contribution; no imported artwork', proof:'docs/third-party/project-assets.md', transformations:'Compiled by Next into same-origin HTML/application code', essential:path.includes('surface'), experience:true, sha256:await hash(path)});

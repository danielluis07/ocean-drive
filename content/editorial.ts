...
export const sourceRecords: Record<SourceId, SourceRecord> = {
  "duarte-heat": {
    ...
    support:
      "Sustenta o pico de 19,65 °C-semanas em 10 de maio e os 50 dias consecutivos acima de 15.",
    boundary:
      "É um índice regional derivado de satélite; não é temperatura local medida por esta expedição.",
  ...
  "noaa-dhw": {
    ...
    support:
      "Explica °C-semana como uma medida de intensidade e duração do calor acumulado nas 12 semanas anteriores.",
    boundary:
      "O produto explica a métrica; o valor histórico de 2019 vem do artigo de Duarte e colaboradores.",
  ...
  "noaa-bleaching": {
    ...
    support:
      "Explica a perda de algas simbióticas, a aparência clara e a possibilidade de recuperação ou morte.",
    boundary:
      "Explica o mecanismo geral; as observações de Abrolhos em 2019 vêm do monitoramento local.",
    ...
    signals: [
      {
        ...
        claims: [
          {
            text: "Em 10 de maio de 2019, o índice regional de estresse térmico acumulado em Abrolhos chegou a 19,65 °C-semanas — o maior valor da série analisada no estudo.",
            sources: ["duarte-heat"],
          },
          {
            text: "O índice foi calculado a partir da temperatura da superfície do mar observada por satélite; não foi medido pela embarcação desta expedição.",
            sources: ["duarte-heat"],
          },
        ],
      },
      {
        ...
        claims: [
          {
            text: "O índice ficou acima de 15 °C-semanas por 50 dias consecutivos, de 12 de abril a 31 de maio.",
            sources: ["duarte-heat"],
          },
          {
            text: "°C-semana combina intensidade e duração do calor acumulado; não é a temperatura da água nem um valor uniforme para cada recife.",
            sources: ["noaa-dhw", "duarte-heat"],
          },
        ],
      },
      {
        ...
        claims: [
          {
            text: "No Parque Nacional Marinho dos Abrolhos, observadores registraram branqueamento já em fevereiro. Depois do pico térmico, o monitoramento continuou.",
            sources: ["icmbio-timeline"],
          },
          {
            text: "Outro levantamento ocorreu em três recifes entre 25 de junho e 5 de julho. Esta estação recompõe uma cronologia histórica, não condições atuais.",
            sources: ["duarte-survey"],
          },
        ],
      },
    ],
    ...
    signals: [
      {
        ...
        claims: [
          {
            text: "Quando sofre estresse, o coral pode perder algas simbióticas e pigmentos, deixando o esqueleto claro visível através do tecido.",
            sources: ["noaa-bleaching"],
          },
          {
            text: "A colônia ainda está viva: se o estresse diminui, pode recuperar-se; se persiste, pode morrer.",
            sources: ["noaa-bleaching"],
          },
        ],
      },
      {
        ...
        claims: [
          {
            text: "Em Mato Verde, seis colônias fixas de Mussismilia braziliensis foram fotografadas semanalmente. Uma branqueou e voltou à condição saudável após o resfriamento; quatro não branquearam. A sexta já branqueava quando foi marcada e morreu.",
            sources: ["icmbio-mussismilia"],
          },
          {
            text: "O grupo ilustra trajetórias possíveis; não estima o destino da espécie nem do recife.",
            sources: ["icmbio-mussismilia"],
          },
        ],
      },
      {
        ...
        claims: [
          {
            text: "No mesmo acompanhamento, as seis colônias fixas de Millepora alcicornis branquearam por completo e morreram.",
            sources: ["icmbio-millepora"],
          },
          {
            text: "Os dois grupos mostram desfechos observados diferentes; não provam que a forma da colônia, sozinha, causou a diferença.",
            sources: ["icmbio-millepora", "icmbio-mussismilia"],
          },
        ],
      },
    ],
    ...
    signals: [
      {
        ...
        claims: [
          {
            text: "Entre 25 de junho e 5 de julho de 2019, pesquisadores compararam Coroa Vermelha, Pedra do Silva e Virada de Fora.",
            sources: ["duarte-survey"],
          },
          {
            text: "Millepora alcicornis apresentou a maior mortalidade observada entre os táxons avaliados nos três locais, mas a intensidade variou muito entre eles.",
            sources: ["duarte-taxa"],
          },
        ],
      },
      {
        ...
        claims: [
          {
            text: "Para M. alcicornis, a mortalidade estimada foi de 43,3 ± 12,0% em Coroa Vermelha, 89,1 ± 3,9% em Pedra do Silva e 83,5 ± 9,0% em Virada de Fora.",
            sources: ["duarte-taxa"],
          },
          {
            text: "São estimativas de transectos para esse organismo — não a parcela de cada recife que morreu.",
            sources: ["duarte-taxa"],
          },
        ],
      },
      {
        ...
        claims: [
          {
            text: "Nos mesmos recifes, Mussismilia braziliensis apresentou branqueamento de 10,2% a 35,4%, enquanto a mortalidade observada ficou entre 0% e 0,2%.",
            sources: ["duarte-taxa"],
          },
          {
            text: "O contraste é entre táxons, locais e categorias da pesquisa; ele não identifica uma causa isolada para as diferenças.",
            sources: ["duarte-taxa"],
          },
        ],
      },
    ...
    signals: [
      {
        ...
        claims: [
          {
            text: "Em 2019, um pulso regional de calor acumulado coincidiu com branqueamento disseminado em Abrolhos.",
            sources: ["duarte-heat", "icmbio-timeline"],
          },
          {
            text: "Branquear revelou estresse, mas não determinou um único desfecho: algumas colônias recuperaram a cor, enquanto outras morreram.",
            sources: [
              "noaa-bleaching",
              "icmbio-mussismilia",
              "icmbio-millepora",
      ...
      },
      {
        ...
        claims: [
          {
            text: "Os números mudam de sentido conforme o organismo, o lugar, a data e o método.",
            sources: ["duarte-taxa"],
          },
          {
